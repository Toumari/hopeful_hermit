...
function add_coloring_book_events() {
	...
	$('path[class="colorable"]').bind("touchstart", function (event) {
	...
	$('.color_choice').bind("touchstart", function (event) {
	...
	$('#reset_image').bind("touchstart", function (event) {
	...
	$('#undo_redo').bind("touchstart", function (event) {
